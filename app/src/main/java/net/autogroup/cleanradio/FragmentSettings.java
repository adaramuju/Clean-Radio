...
import net.autogroup.cleanradio.interfaces.IApplicationSelected;
import net.autogroup.cleanradio.proxy.ProxySettingsDialog;
...
import static net.autogroup.cleanradio.ActivityMain.FRAGMENT_FROM_BACKSTACK;
