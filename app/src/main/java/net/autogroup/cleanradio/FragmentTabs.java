...
import net.autogroup.cleanradio.interfaces.IFragmentSearchable;
...
public class FragmentTabs extends Fragment implements IFragmentRefreshable, IFragmentSearchable {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        if (ctx != null) {
            ...
            Log.e("YYY", "Found countrycodex " + countryCode);
            country = CountryCodeDictionary.getInstance().getCountryByCode(countryCode);
            Log.e("YYY", "Found country " + country);


            adresses[0] = "json/stations/bycountryexact/" + country + "?order=clickcount&reverse=true&limit=20";
        }
        ...
        adapter.addFragment(new FragmentStarred(), R.string.action_favorites);
