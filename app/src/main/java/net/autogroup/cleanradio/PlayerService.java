...
import net.autogroup.cleanradio.players.RadioPlayer;
import net.autogroup.cleanradio.recording.RecordingsManager;
import net.autogroup.cleanradio.recording.RunningRecordingInfo;
...
public class PlayerService extends Service implements RadioPlayer.PlayerListener {
    ...
    public static final String PLAYER_SERVICE_TIMER_UPDATE = "net.autogroup.cleanradio.timerupdate";
    public static final String PLAYER_SERVICE_STATUS_UPDATE = "net.autogroup.cleanradio.statusupdate";
    public static final String PLAYER_SERVICE_META_UPDATE = "net.autogroup.cleanradio.metaupdate";
